...
public class ExceptionTests
{
    ...
    public void Test_PerformSecureOperation_UserLoggedIn_ReturnsUserLoggedInMessage()
    {
        ...
        // Act
        string result = this._exceptions.InvalidOperationPerformSecureOperation(logedIn);
    ...
    public void Test_SumCollectionElements_NullCollection_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Assert.That(() => this._exceptions.SumCollectionElements(colections, index), Throws.ArgumentNullException);
    }
    ...
    public void Test_GetElementAsNumber_ValidKey_ReturnsParsedNumber()
    {
        ...
        // Act
        int result = this._exceptions.GetElementAsNumber(colection, key);
    ...
    public void Test_GetElementAsNumber_InvalidFormat_ThrowsFormatException()
    {
        ...
        // Act & Assert
        Assert.That(() => this._exceptions.GetElementAsNumber(colection, key), Throws.InstanceOf<FormatException>());   
    }
}
